  ...
  return (
    <>
        ...
        <div className="header-container">
          ...
          <nav>
            <ul>
              ...
              <li><Link to="/opinion">건의사항</Link></li>
      ...
      <div className="section1">
        <h2 className="section-title1">🎯 설립 목적</h2>
        <div className="purpose-grid1">
      ...
      {/* 설립 과정 */}
      <div className="section1">
        <h2 className="section-title1">📋 설립 과정</h2>
      ...
      {/* 위원회 성격 */}
      <div className="section1">
        <h2 className="section-title1">🏛️ 위원회 성격</h2>
        <div className="characteristics1">
          <div className="characteristic-item1">
            <h3>개방적 참여</h3>
      ...
      {/* 주요 역할 */}
      <div className="section1">
        <h2 className="section-title1">⚡ 주요 역할</h2>
        <div className="roles1">
          <div className="role-item1">
            <h3>미래 전략 수립</h3>
